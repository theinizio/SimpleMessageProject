...
<div class="container">	
			...
			<div class="row-fluid">
				<div class="span12">
					...
					<div class="span4">
						<p class="muted pull-right">© 2018 ЧП Тукан. All rights reserved</p>
					</div>
				</div>
			</div>
  </div>    
...
<script>window.jQuery || document.write('<script src="<?php echo $set->url;?>/js/vendor/jquery-1.11.0.min.js"><\/script>')</script>
